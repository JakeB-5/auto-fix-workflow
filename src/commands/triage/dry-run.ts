...
export class DryRunSimulator {
  ...
  /**
   * Simulate task analysis (returns mock data)
   */
  ...
  /**
   * Record actual analysis result (for dry-run with real AI)
   */
  recordAnalysis(task: AsanaTask, analysis: TaskAnalysis): void {
    this.actions.push({
      type: 'ANALYZE_TASK',
      taskGid: task.gid,
      taskName: task.name,
      description: `AI analysis: ${analysis.issueType} (${analysis.component}, confidence: ${Math.round(analysis.confidence * 100)}%)`,
      details: {
